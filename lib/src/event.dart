...
class WxAnchorEvent extends WidgetEvent {
  ...
  static const disabled = WxAnchorEvent('disabled');

  /// The state when the user navigates with the keyboard to a given widget.
  static const focused = WxAnchorEvent('focused');

  /// The state when the user drags their mouse cursor over the given widget.
  static const hovered = WxAnchorEvent('hovered');

  /// The state when the user is actively pressing down on the given widget.
  static const pressed = WxAnchorEvent('pressed');
...
typedef WxAnchorEventController = WidgetEventController;
